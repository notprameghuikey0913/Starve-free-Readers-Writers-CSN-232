...
#include<math.h>
/* 
    sem_t is a typedef defined in a header file as an unsigned char
...
/*
    ...
    Thus a mutex offers stronger protection than an ordinary semaphore.
...
int resource = 1;
// READER COUNT
unsigned int readers = 0; // number of readers that are accessing resource
